<?php
  ...
  {
      header('Location:failedtoproceed.php');
  }
  ?>
...
<html lang="en">
  <head>
    <title>HIREFLUENT|Company|Login</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    position: absolute;">Company Login</h1>
                    <div class="" id="v-pills-1" role="tabpanel" aria-labelledby="">
                    <form action="company_action.php" method="POST" class="subscribe-form">
    ...
    position: absolute;" required type="number/text" name="company_id" class="" placeholder="Company ID">
                      <br>
                      <br>
                      <input style=" left: 50%;
    top: 50%;
    ...
    margin-left: -115px; /* width/2 */
    position: absolute;" ><a href="register_company.php">Register Your Company in Jobshop</a></button>
                    </div>
