...
<head>
  ...
  <script>
    function Add(){
      alert("Your Job is Added Successfully");
  ...
  <section>
    <header id="homeheader">
      ...
      <nav>
        <ul class="nav-links">
          ...
          <li>
            <a class="active" href="../../logout.php" onclick="Submit()">Log Out</a>
          </li>
        </ul>
      </nav>
    </header>
    <div class="mainbodyuser">
      ...
      <div class="drawerRight center">
        ...
        <form class="" action="job_added.php?company_id=<?php echo $profile;?>" method="POST" enctype="multipart/form-data" name="myform">
            <div class="formSide">
...
<div class="col-md-8">
  ...
  <br>
  <br>
  <button  type="submit" name="submit" onclick="Add()" value="reset" >Add Job</button>
        </form>
        </div>
      </div>
    </div>
