...
<html lang="en">
  ...
  <body>
    ...
    position: absolute;">Reset Password</h1>
                    <div class="" id="v-pills-1" role="tabpanel" aria-labelledby="">
                    <form action="reset.php?user_id=<?php echo $user_id;?>" method="POST" class="subscribe-form">
    ...
    margin-left: -115px; /* width/2 */
    position: absolute;" type="submit" name="submit">Reset</button>
