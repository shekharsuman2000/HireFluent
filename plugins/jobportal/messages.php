...
$r_id = $r_id;
$query = "SELECT * FROM login WHERE user_id ='$r_id'";
...
<html lang="en">
  ...
  <body>
    ...
    position: absolute;">Send Messages to <?php echo $reciver_name;    ?> </p>
                    <div class="" id="v-pills-1" role="tabpanel" aria-labelledby="">
                    <form action="" method="POST" class="subscribe-form">
               

   <iframe width="600px" height=600px style="margin-left: 300px;" src="../../messages/index.php?r_id= <?php echo $r_id;?>&&sender_id=<?php echo $sender_id; ?>"style="border: none;"></iframe>
