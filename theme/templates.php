...
<html lang="en">
  <head>
    <title>HIREFLUENT|Freelancer</title>
    <link rel="icon" href="plugins/jobportal/images/job.png" type="image/icon type">
    <meta charset="utf-8">
...
{  
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="<?php echo web_root; ?>">HireFluent</a>
...
{
  $work="Work as a freelancer";
}
 else
 {
   $work="Hire a Freelancer";
 }
...
?>
            ...
            <li class="nav-item <?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a  class="nav-link" href="<?php echo web_root; ?>index.php?q=hiring">Hiring Now</a></li>
                ...
                <li class="nav-item <?php  if(isset($_GET['q'])) { if($_GET['q']=='Freelancer'){ echo 'active'; }else{ echo ''; }} ?>"><a  class="nav-link"href="<?php echo web_root; ?>index.php?q=Freelancer"><?php echo $work;    ?></a></li>
...
if (isset($_SESSION['user_id'])==true)
{
$logged_in='profile.php?profile_id='.$id;
}
else 
{
$logged_in ='login.php';
...
<li   class="nav-item login"><a href ="plugins/jobportal/<?php echo $logged_in;   ?>" class="nav-link"><?php echo $file;?>


<li   class="nav-item login"><a href ="logout.php" class="nav-link"><?php echo $check;?></a>
...
?>
             ...
             <li class="nav-item cta mr-md-2"><a href="<?php echo web_root; ?>admin/" class="nav-link">Admin</a></li>
             <?php
              }
             else
             { ?>

              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'applicant/';?>"><i class="fa fa-user"></i> <?php echo  $_SESSION['user_id'];?>
              </a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'logout.php';?>"><i class="fa fa-user"></i> Logout</a></li>
             <?php } ?> 
            <li class="nav-item cta cta-colored"><a href="plugins/jobportal/company_login.php" class="nav-link">Company Login</a></li>
      ...
      <div class="container">
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 7488228963</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@jobshop</span></a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <!-- | Developed with  <i class="icon-heart text-danger" aria-hidden="true"></i>  <a href="#" target="_blank"> by Akash & Sumeet</a> -->
</p>
          </div>
        </div>
      </div>
  ...
  <script src="<?php echo web_root; ?>plugins/jobportal/js/main.js"></script>
    ...
    $('#dash-table2').DataTable({
     ...
     $("#btnlogin").click(function(){
        var username = document.getElementById("user_user_id");
